    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="{{route('adminhome')}}">
                <img alt="" src="{{$hotel->logo ?? asset('backend/assets/img/logo.png')}}">
{{--                <img alt="" src="storage/{{$hotel->logo ?? asset('backend/{{asset('backend/ssets/img/logo.png')}}">--}}
                <span class="logo-default" >{{$hotel->name ?? 'Hotel'}}</span> </a>
        </div>
        <!-- logo end -->
        ...
        <div class="top-menu">
            <ul class="nav navbar-nav pull-right">
                        ...
                        <li>
                            <ul class="dropdown-menu-list small-slimscroll-style" data-handle-color="#637283">
                                ...
                                <li>
                                    <a href="#">
                                                <span class="photo">
                                                	<img src="{{asset('backend/assets/img/user/user1.jpg')}}" class="img-circle" alt=""> </span>
                                        <span class="subject">
                                ...
                                <li>
                                    <a href="#">
                                                <span class="photo">
                                                	<img src="{{asset('backend/assets/img/user/user8.jpg')}}" class="img-circle" alt=""> </span>
                                        <span class="subject">
                                ...
                                <li>
                                    <a href="#">
                                                <span class="photo">
                                                	<img src="{{asset('backend/assets/img/user/user5.jpg')}}" class="img-circle" alt=""> </span>
                                        <span class="subject">
                ...
                <li class="dropdown dropdown-user">
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                        <img alt="" class="img-circle " src="{{asset('backend/assets/img/dp.jpg')}}" />
